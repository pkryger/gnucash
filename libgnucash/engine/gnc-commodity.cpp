...
static QuoteSourceList single_quote_sources =
{
    ...
    { false, SOURCE_SINGLE, N_("Amsterdam Euronext eXchange, NL"), "aex" },
    { false, SOURCE_SINGLE, N_("Association of Mutual Funds in India"), "amfiindia" },
    { false, SOURCE_SINGLE, N_("Athens Exchange Group, GR"), "asegr" },
    { false, SOURCE_SINGLE, N_("Australian Stock Exchange, AU"), "asx" },
    { false, SOURCE_SINGLE, N_("Bloomberg"), "bloomberg" },
    { false, SOURCE_SINGLE, N_("Italian Stock Exchange, IT"), "borsa_italiana" },
    { false, SOURCE_SINGLE, N_("BSE India, IN"), "bseindia" },
    { false, SOURCE_SINGLE, N_("Bucharest Stock Exchange, RO"), "bvb" },
    { false, SOURCE_SINGLE, N_("Colombo Stock Exchange, LK"), "cse" },
    { false, SOURCE_SINGLE, N_("comdirect, DE"), "comdirect" },
    { false, SOURCE_SINGLE, N_("Consors Bank, DE"), "consorsbank" },
    { false, SOURCE_SINGLE, N_("Deka Investments, DE"), "deka" },
    { false, SOURCE_SINGLE, N_("DWS, DE"), "dwsfunds" },
    { false, SOURCE_SINGLE, N_("Financial Times Funds service, GB"), "ftfunds" },
    { false, SOURCE_SINGLE, N_("Finanzpartner, DE"), "finanzpartner" },
    { false, SOURCE_SINGLE, N_("FondsWeb, DE"), "fondsweb" },
    { false, SOURCE_SINGLE, N_("GoldMoney precious metals"), "goldmoney" },
    { false, SOURCE_SINGLE, N_("Google Web, US Stocks"), "googleweb" },
    { false, SOURCE_SINGLE, N_("IEX (Investors Exchange), US"), "iexcloud" },
    { false, SOURCE_SINGLE, N_("Market Watch"), "marketwatch" },
    { false, SOURCE_SINGLE, N_("Morningstar, AU"), "morningstarau" },
    { false, SOURCE_SINGLE, N_("Morningstar, CH"), "morningstarch" },
    { false, SOURCE_SINGLE, N_("Morningstar, GB"), "morningstaruk" },
    { false, SOURCE_SINGLE, N_("Morningstar, JP"), "morningstarjp" },
    { false, SOURCE_SINGLE, N_("Motley Fool"), "fool" },
    { false, SOURCE_SINGLE, N_("New Zealand stock eXchange, NZ"), "nzx" },
    { false, SOURCE_SINGLE, N_("NSE (National Stock Exchange), IN"), "nseindia" },
    { false, SOURCE_SINGLE, N_("OnVista, DE"), "onvista"},
    { false, SOURCE_SINGLE, N_("Paris Stock Exchange/Boursorama, FR"), "bourso" },
    { false, SOURCE_SINGLE, N_("S-Investor, DE"), "sinvestor"},
    { false, SOURCE_SINGLE, N_("Sharenet, ZA"), "za" },
    { false, SOURCE_SINGLE, N_("SIX Swiss Exchange shares, CH"), "six" },
    { false, SOURCE_SINGLE, N_("Skandinaviska Enskilda Banken, SE"), "seb_funds" },
    { false, SOURCE_SINGLE, N_("StockData"), "stockdata" },
    { false, SOURCE_SINGLE, N_("Stooq, PL"), "stooq" },
    { false, SOURCE_SINGLE, N_("T. Rowe Price, US"), "troweprice" },
    { false, SOURCE_SINGLE, N_("Tesouro Direto bonds, BR"), "tesouro_direto" },
    { false, SOURCE_SINGLE, N_("TIAA-CREF, US"), "tiaacref" },
    { false, SOURCE_SINGLE, N_("Toronto Stock eXchange, CA"), "tsx" },
    { false, SOURCE_SINGLE, N_("Tradegate, DE"), "tradegate" },
    { false, SOURCE_SINGLE, N_("Treasury Direct bonds, US"), "treasurydirect" },
    { false, SOURCE_SINGLE, N_("Twelve Data"), "twelvedata" },
    { false, SOURCE_SINGLE, N_("Union Investment, DE"), "unionfunds" },
    { false, SOURCE_SINGLE, N_("US Govt. Thrift Savings Plan"), "tsp" },
    { false, SOURCE_SINGLE, N_("XETRA, DE"), "xetra" },
    { false, SOURCE_SINGLE, N_("Yahoo as JSON"), "yahoo_json" },
    { false, SOURCE_SINGLE, N_("Yahoo Web"), "yahooweb" },
    { false, SOURCE_SINGLE, N_("YH Finance (FinanceAPI)"), "financeapi" },
};

static QuoteSourceList multiple_quote_sources =
{
    { false, SOURCE_MULTI, N_("Australia (ASX)"), "australia" },
    { false, SOURCE_MULTI, N_("Australia Funds (MorningstarAU)"), "aufunds" },
    { false, SOURCE_MULTI, N_("Canada (Alphavantage, TMX)"), "canada" },
    { false, SOURCE_MULTI, N_("Dutch (AEX)"), "dutch" },
    { false, SOURCE_MULTI, N_("Europe (ASEGR, Bourso, …)"), "europe" },
    { false, SOURCE_MULTI, N_("France (Bourso)"), "france" },
    { false, SOURCE_MULTI, N_("Greece (ASEGR)"), "greece" },
    { false, SOURCE_MULTI, N_("India (BSEIndia, NSEIndia)"), "india"},
    { false, SOURCE_MULTI, N_("India Mutual (AMFI)"), "indiamutual" },
    { false, SOURCE_MULTI, N_("Nasdaq (Alphavantage, FinanceAPI, …)"), "nasdaq" },
    { false, SOURCE_MULTI, N_("NYSE (Alphavantage, FinanceAPI, …)"), "nyse" },
    { false, SOURCE_MULTI, N_("Poland (Stooq)"), "poland" },
    { false, SOURCE_MULTI, N_("Romania (BVB)"), "romania" },
    { false, SOURCE_MULTI, N_("South Africa (Sharenet)"), "za" },
    { false, SOURCE_MULTI, N_("U.K. Funds (FTfunds, MorningstarUK)"), "ukfunds" },
    { false, SOURCE_MULTI, N_("USA (Alphavantage, FinanceAPI, …)"), "usa" },
};
